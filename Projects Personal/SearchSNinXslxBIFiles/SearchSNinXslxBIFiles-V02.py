...
# -- Version 0.2 - Added a GUI for introduce Serial number  
# ----------------------------------------------------------------------------------------------
import os
import pandas as pd
...
# SEARCH_SERIAL_NUMBER = "H24320004K"  # use this variant without GUI.
...
# Ask for a serial number GUI 
search_serial_number = simpledialog.askstring("Input", "Enter the serial number to search for:")
