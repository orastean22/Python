...
label = Label(myWindow, width=50, text="OT2_GD Over Temperature Warning", font = ("Courrier New",15), fg='white', bg='blue')
label.grid(column=0, row=5, sticky="w")
label = Label(myWindow, width=50, text="OT1_GD Over Temperature Warning", font = ("Courrier New",15), fg='black', bg='white')
label.grid(column=0, row=6, sticky="w")
label = Label(myWindow, width=50, text="Secondary Side FluxLink out-of-service Warning", font = ("Courrier New",15), fg='white', bg='blue')
label.grid(column=0, row=7, sticky="w")
label = Label(myWindow, width=50, text="Short Circuit Detection Fault", font = ("Courrier New",15), fg='black', bg='white')
label.grid(column=0, row=8, sticky="w")
label = Label(myWindow, width=50, text="Parity Bit of Secondary-to-Primary side Communication", font = ("Courrier New",15), fg='white', bg='blue')
label.grid(column=0, row=9, sticky="w")
label = Label(myWindow, width=50, text="Primary Side FluxLink out-of-service Warning", font = ("Courrier New",15), fg='black', bg='white')
label.grid(column=0, row=10, sticky="w")
label = Label(myWindow, width=50, text="OT1_DCDC Over Temperature Warning", font = ("Courrier New",15), fg='white', bg='blue')
label.grid(column=0, row=11, sticky="w")
label = Label(myWindow, width=50, text="OT2_DCDC Over Temperature Warning", font = ("Courrier New",15), fg='black', bg='white')
label.grid(column=0, row=12, sticky="w")
label = Label(myWindow, width=50, text="Primary Side DC/DC Controller Over-Current Warning", font = ("Courrier New",15), fg='white', bg='blue')
...
scope.WriteString("vbs 'Cells = app.SerialDecode.Decode1.Out.Result.CellValue(1, 6) '", True)
scope.WriteString("vbs? 'Return = Cells(0,0)'", True)
dataPayloadStr = bin (int(scope.ReadString(30)) + 2**28)
