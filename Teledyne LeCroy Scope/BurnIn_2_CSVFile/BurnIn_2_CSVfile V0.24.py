...
def setup_gui():
    ...
    ip_scope_1_label = tk.Label(root, text=f"Scope 1 IP: {config['oscilloscope_1_ip']}", font=("Arial", 11))  
    ip_scope_1_label.pack()                                                                                   
    ip_scope_2_label = tk.Label(root, text=f"Scope 2 IP: {config['oscilloscope_2_ip']}", font=("Arial", 11))  
    ...
    version_label = tk.Label(root, text="V0.24 by AdrianO", font=("Arial", 10), anchor="se")
