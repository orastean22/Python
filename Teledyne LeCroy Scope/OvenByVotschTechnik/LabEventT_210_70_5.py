...
OVEN_IP = '10.30.11.1'  # Replace with your oven's IP address
PORT = 5025                # Replace with the actual port for SCPI commands

# Create a socket connection to the oven
sock = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
sock.connect((OVEN_IP, PORT))

# SCPI command to set the temperature (this is just an example, refer to the manual for actual commands)
scpi_command = f'SET:TEMP {70}\n'  # Replace 70 with the desired temperature
